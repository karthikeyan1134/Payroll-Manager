        ...
        while (true) {
            ...
            if (!input.empty()) {
                ...
                if (temp.getIO()) {
                    ...
                    log << "Employee ID: " << empl << " left the office at " << Times.ist() << endl;
                    time_t current_time = time(NULL);
                    ...
                    log << "Employee ID: " << empl << " entered the office at " << Times.ist() << endl;
                    time_t current_time = time(NULL);
